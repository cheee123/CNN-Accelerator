...
wire signed [31:0] bias_q = (layer==2'd2)? 32'd41 : -32'd128;
...
assign Msum_dec[0] = Msum[0][63:32] + bias_q + {31'd0,(Msum[0][31]&&(Msum[0][30:0]))};
assign sum_ow[1] = outbuf[1] - ow[4] + ow[5];
assign Msum[1] = sum_ow[1] * ow[3];
assign Msum_dec[1] = Msum[1][63:32] + bias_q + {31'd0,(Msum[1][31]&&(Msum[1][30:0]))};
assign sum_ow[2] = outbuf[2] - ow[7] + ow[8];
assign Msum[2] = sum_ow[2] * ow[6];
assign Msum_dec[2] = Msum[2][63:32] + bias_q + {31'd0,(Msum[2][31]&&(Msum[2][30:0]))};
assign sum_ow[3] = outbuf[3] - ow[10] + ow[11];
assign Msum[3] = sum_ow[3] * ow[9];
assign Msum_dec[3] = Msum[3][63:32] + bias_q + {31'd0,(Msum[3][31]&&(Msum[3][30:0]))};
assign sum_ow[4] = outbuf[4] - ow[13] + ow[14];
assign Msum[4] = sum_ow[4] * ow[12];
assign Msum_dec[4] = Msum[4][63:32] + bias_q + {31'd0,(Msum[4][31]&&(Msum[4][30:0]))};
assign sum_ow[5] = outbuf[5] - ow[16] + ow[17];
assign Msum[5] = sum_ow[5] * ow[15];
assign Msum_dec[5] = Msum[5][63:32] + bias_q + {31'd0,(Msum[5][31]&&(Msum[5][30:0]))};
assign sum_ow[6] = outbuf[6] - ow[19] + ow[20];
assign Msum[6] = sum_ow[6] * ow[18];
assign Msum_dec[6] = Msum[6][63:32] + bias_q + {31'd0,(Msum[6][31]&&(Msum[6][30:0]))};
assign sum_ow[7] = outbuf[7] - ow[22] + ow[23];
assign Msum[7] = sum_ow[7] * ow[21];
assign Msum_dec[7] = Msum[7][63:32] + bias_q + {31'd0,(Msum[7][31]&&(Msum[7][30:0]))};
assign sum_ow[8] = outbuf[8] - ow[25] + ow[26];
assign Msum[8] = sum_ow[8] * ow[24];
assign Msum_dec[8] = Msum[8][63:32] + bias_q + {31'd0,(Msum[8][31]&&(Msum[8][30:0]))};
assign sum_ow[9] = outbuf[9] - ow[28] + ow[29];
assign Msum[9] = sum_ow[9] * ow[27];
assign Msum_dec[9] = Msum[9][63:32] + bias_q + {31'd0,(Msum[9][31]&&(Msum[9][30:0]))};
assign sum_ow[10] = outbuf[10] - ow[31] + ow[32];
assign Msum[10] = sum_ow[10] * ow[30];
assign Msum_dec[10] = Msum[10][63:32] + bias_q + {31'd0,(Msum[10][31]&&(Msum[10][30:0]))};
assign sum_ow[11] = outbuf[11] - ow[34] + ow[35];
assign Msum[11] = sum_ow[11] * ow[33];
assign Msum_dec[11] = Msum[11][63:32] + bias_q + {31'd0,(Msum[11][31]&&(Msum[11][30:0]))};
endmodule
